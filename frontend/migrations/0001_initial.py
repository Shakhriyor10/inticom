# Generated manually for project schema
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_per_hour', models.PositiveIntegerField(verbose_name='Цена за 1 час')),
                ('price_for_two_hours', models.PositiveIntegerField(verbose_name='Цена за 2 часа')),
                ('price_for_night', models.PositiveIntegerField(verbose_name='Цена за ночь')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
